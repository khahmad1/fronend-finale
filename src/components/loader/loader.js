      ...
      <svg className="loading" width="512" height="512" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <defs>
          <g id="everything">
            ...
            <use href="#pill_bottom" filter="url(#shadowBottom)" stroke="var(--secondary)" strokeWidth="2" />
            <use href="#bubble1" />
            <use href="#bubble2" />
            <use href="#bubble3" />
            <use href="#bubble4" />
            <use href="#pill_outline" stroke="var(--secondary)" strokeWidth="10" />
            <use href="#pill_outline" stroke="#fff" strokeWidth="6" />
          </g>
          <path id="pill_outline" strokeLinejoin="round">
          ...
          <g id="pill_shadow" filter="url(#labelClip)">
            <use href="#pill_outline" fill="rgba(3, 3,3, 0.2)" y="128">
          ...
          <path id="pill_bottom" fill="var(--primary)">
          ...
          <path id="pill_bottom_back" fill="rgba(255, 255, 255, 0.2)">
            <animate attributeName="d" dur="4s" repeatCount="indefinite" calcMode="linear"
              keyTimes="0;0.25;0.5;0.75;1" keySplines="0.5 0 0.5 1; 0.5 0 0.5 1; 0.5 0 0.5 1; 0.5 0 0.5 1"
          ...
          <circle id="bubble1" cy="180" r="4" fill="rgba(255, 255, 255, 0.2)">
            <animate attributeName="cx" dur="4s" repeatCount="indefinite" calcMode="spline"
              keyTimes="0;0.5;1" keySplines="0.5 0 0.5 1; 0.5 0 0.5 1"
              values="216;266;216" />
          </circle>
          <circle id="bubble2" cy="160" r="6" fill="rgba(255, 255, 255, 0.2)">
            <animate attributeName="cx" dur="4s" repeatCount="indefinite" calcMode="spline"
              keyTimes="0;0.5;1" keySplines="0.5 0 0.5 1; 0.5 0 0.5 1"
              values="236;276;236" />
          </circle>
          <circle id="bubble3" cy="140" r="10" fill="rgba(255, 255, 255, 0.2)">
            <animate attributeName="cx" dur="4s" repeatCount="indefinite" calcMode="spline"
              keyTimes="0;0.5;1" keySplines="0.5 0 0.5 1; 0.5 0 0.5 1"
              values="226;276;226" />
          </circle>
          <circle id="bubble4" cy="135" r="4" fill="rgba(255, 255, 255, 0.2)">
            <animate attributeName="cx" dur="4s" repeatCount="indefinite" calcMode="spline"
              keyTimes="0;0.5;1" keySplines="0.5 0 0.5 1; 0.5 0 0.5 1"
              values="276;236;276" />
          </circle>
          <path id="pill_top" fill="var(--secondary)" strokeWidth="2">
            <animate attributeName="d" dur="4s" repeatCount="indefinite" calcMode="linear"
              keyTimes="0;0.25;0.5;0.75;1" keySplines="0.5 0 0.5 1; 0.5 0 0.5 1; 0.5 0 0.5 1; 0.5 0 0.5 1"
